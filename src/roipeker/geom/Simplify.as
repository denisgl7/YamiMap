...
public class Simplify {
    ...
    public static function simplifyRadialDistance(points:Array, sqTolerance:Number):Array { // distance-based simplification

        var i:int;
        var len:int = points.length;
        var point:Point;
        var prevPoint:Point = points[0];
        var newPoints:Array = null;
        newPoints = [prevPoint];
    ...
    public static function simplifyDouglasPeucker(points:Array, sqTolerance:Number):Array {
        var len:int = points.length;
        var markers:Vector.<int> = new Vector.<int>(len);
        var first:int = 0;
        var last:int = len - 1;
        ...
        var firstStack:Vector.<int> = new Vector.<int>();
        var lastStack:Vector.<int> = new Vector.<int>();
        var newPoints:Array = [] ;
    ...
    public static function simplify(points:Array, tolerance:Number = 1, highestQuality:Boolean =
            false):Array {
