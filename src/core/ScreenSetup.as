...
public class ScreenSetup
    {
        ...
        public function onResize():void {
            var view:Rectangle = Starling.current.viewPort ;
            Starling.current.stage.stageWidth = int(Starling.current.nativeStage.stageWidth/_scale);
            Starling.current.stage.stageHeight = int(Starling.current.nativeStage.stageHeight/_scale);

            view.width = Starling.current.stage.stageWidth*scale;
            view.height = Starling.current.stage.stageHeight*scale;
//            _stageWidth  = int(stagefullScreenWidth  / _scale);
//            view.height = stage.stageHeight;
            Starling.current.viewPort = view;
//            trace('stage resize:', stage.stageWidth);
            ...
            view.height = sh ;
            Starling.current.viewPort = view ;
            Starling.current.stage.stageWidth = view.width ;
            Starling.current.stage.stageHeight = view.height;*/
        }
    }
}
